...
# # Always use the relative yolov5 path (for Docker and Linux/Windows portability)
...
# # Load YOLOv5 model and classifier weights from inside the container
...
# )
# # Load classifier weights from inside yolov5 folder
# model.load_state_dict(torch.load(str(yolov5_path / "efficientnet_b7_har_finetuned.pth"), map_location=device))
...
def predict():
    ...
    if actions:
        # Return all detected persons' actions
